            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="relative aspect-video overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-dark/60 transition-opacity duration-500 opacity-0 group-hover:opacity-100">
                    <div className="absolute inset-0 flex items-center justify-center gap-4">
                      <motion.a
                        ...
                        whileTap={{ scale: 0.9 }}
                        className="p-3 bg-accent/20 hover:bg-accent/40 rounded-full text-text-light transition-colors"
                      >
